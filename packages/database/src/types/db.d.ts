...
export interface TwitchProfilePictures {
  created_at: Generated<Timestamp>;
...
export interface DB {
  ...
  twitch_profile_pictures: TwitchProfilePictures;
  user_correlation: UserCorrelation;
  users: Users;
  youtube_names: YoutubeNames;
  youtube_oauth_tokens: YoutubeOauthTokens;
}
